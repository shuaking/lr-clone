...
一个语言学习 Web 应用，实现了 Language Reactor 的**部分核心功能**。

> **重要说明**: 本项目是独立 Web App，不是浏览器扩展。与 Language Reactor 相比，约实现了 40-50% 的功能。

## ✨ 已实现功能

### 核心功能
- 🎥 **YouTube 视频播放器** - 嵌入式播放，字幕同步
- 📝 **字幕显示系统** - 字幕面板，时间轴跳转，字幕编辑
...
### 缺失功能
- ❌ **PhrasePump 训练模式** - 听句子→猜意思的 SRS 训练系统（完全缺失）
...
### 部分实现的功能
- 🟡 **双语字幕系统** - 架构完成，但 UI 未完全实现上下两行对照显示
- 🟡 **词汇管理** - 基础功能完成，但 SRS 系统不完整
